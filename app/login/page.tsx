      ...
      <div className="animate-pop w-full max-w-sm">
        <div className="card overflow-hidden">
          ...
          <div className="p-8 text-center">
            ...
            <h1 className="mb-1 text-lg font-bold tracking-tight">Sign in to bookme</h1>
            ...
            <p className="mt-7 text-xs text-ink/50">New here? Signing in creates your account.</p>
